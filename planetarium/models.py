...
class ShowTheme(models.Model):
    ...
    name = models.CharField(
        max_length=100, help_text="Enter the name of the show theme."
    )
...
class AstronomyShow(models.Model):
    ...
    title = models.CharField(
        max_length=100, help_text="Enter the title of the astronomy show."
    )
...
class PlanetariumDome(models.Model):
    ...
    name = models.CharField(
        max_length=100, help_text="Enter the name of the planetarium dome."
    )
    rows = models.IntegerField(help_text="Enter the number of rows in the dome.")
...
class Reservation(models.Model):
    ...
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="Date and time when the reservation was created."
    )
